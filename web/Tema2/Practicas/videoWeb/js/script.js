window.onload = function() {
  ...
  bEs = document.querySelector("#buttonEs");
...
var videoAgricultura = document.querySelector("#Agricultura");
var videoOvejas = document.querySelector("#Ovejas");
var videoTrigo = document.querySelector("#Trigo");


    function playVideo() {
        videoAgricultura.play();
        videoOvejas.play();
        videoTrigo.play();
    }
    
    function pauseVideo() {
        videoAgricultura.pause();
        videoOvejas.pause();
        videoTrigo.pause();
    }

    function stopVideo() {
        videoAgricultura.currentTime = 0;
        videoOvejas.currentTime = 0;
        videoTrigo.currentTime = 0;
        videoAgricultura.pause();
        videoOvejas.pause();
        videoTrigo.pause();
    }
    ...
    var buttonEnglish, buttonDeutsch, bEs;
